    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yimiao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="疫苗标题" prop="yimiaoName">
                        <el-input v-model="yimiaoForm.yimiaoName"
                                  placeholder="疫苗标题" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='yimiao' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='yimiao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="yimiaoClicknum">
                        <el-input v-model="yimiaoForm.yimiaoClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="yimiaoClicknum">
                            <el-input v-model="ruleForm.yimiaoClicknum"
            ...
            <input id="yimiaoId" name="yimiaoId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约日期" prop="yuyuejiezongTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.yuyuejiezongTime"
                                type="date"
                                placeholder="预约日期"
                                :disabled="ro.yuyuejiezongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyuejiezongTime" label="预约日期" prop="yuyuejiezongTime">
                            <span v-html="ruleForm.yuyuejiezongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约备注" prop="yuyuejiezongText">
                        <el-input type="textarea"  :readonly="ro.yuyuejiezongText" v-model="ruleForm.yuyuejiezongText" placeholder="预约备注"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyuejiezongText" label="预约备注" prop="yuyuejiezongText">
                            <span v-html="ruleForm.yuyuejiezongText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yimiaoId: false,
                    yuyuejiezongTime: false,
                    yuyuejiezongText: false,
                    yuyuejiezongYesnoTypes: false,
                    yuyuejiezongYesnoText: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yimiaoId: '',
                    yuyuejiezongTime: '',
                    yuyuejiezongText: '',
                    yuyuejiezongYesnoTypes: '',
                    yuyuejiezongYesnoText: '',
                },
                yuyuejiezongYesnoTypesOptions : [],
                yimiaoOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuyuejiezong_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuyuejiezongYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yuyuejiezong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yuyuejiezongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
