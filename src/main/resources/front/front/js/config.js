...
var indexNav = [
    ...
    {
        name: '疫苗信息',
        url: './pages/yimiao/list.html'
    },
    {
        name: '医院信息',
        url: './pages/yiyuan/list.html'
    }

]

var adminurl =  "http://localhost:8080/yimiaofabuhejiezhong/admin/dist/index.html#/login";
